...
<form class="form-horizontal" autocomplete="off" >
	<div class="form-body">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input type="text" name="iusername" class="form-control" placeholder="Username" required value="<?php echo $username ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-3 control-label">Password <i class="asterisk">*</i></label>
			<div class="col-md-9">
				<input type="password" name="ipassword" class="form-control" placeholder="Password" required value="<?php echo $password ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-3 control-label">First Name <i class="asterisk">*</i></label>
			<div class="col-md-9">
				<input type="text" name="ifirst_name" class="form-control" placeholder="First Name" required value="<?php echo $first_name ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-3 control-label">Last Name <i class="asterisk">*</i></label>
			<div class="col-md-9">
				<input type="text" name="ilast_name" class="form-control" placeholder="Last Name" required value="<?php echo $last_name ?>">
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-3 control-label">Email <i class="asterisk">*</i></label>
			<div class="col-md-9">
				<input type="email" name="iemail" class="form-control" placeholder="Email" required value="<?php echo $email ?>">
			</div>
		</div>
	</div>
</form>
